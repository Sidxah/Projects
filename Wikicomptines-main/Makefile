...
all: wcp_clt wcp_srv test_comptine_utils
...
test_comptine_utils: test_comptine_utils.o 
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
...
test_comptine_utils.o: test_comptine_utils.c comptine_utils.h

.PHONY: clean
clean:
	rm -f *.o wcp_srv wcp_clt test_comptine_utils
